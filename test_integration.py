...
from client import save_keys, load_keys, authenticate, send_messages, receive_messages  # Import necessary functions from client.py
...
class TestClientServerIntegration(unittest.TestCase):
    ...
    def test_integration_scenario(self, mock_socket):
        ...
        save_keys(self.client_id, self.rsa_public_key, self.rsa_private_key, self.private_dh_key)
        ...
        # Cleanup
        os.remove(f"{self.client_id}_keys.json")
